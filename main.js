...
const starts = async (zeroyt7 = new WAConnection()) => {
    ...
    ownerNumber = ["6281319944917@s.whatsapp.net",`6289653381067@s.whatsapp.net`]
     gisa = "6289653381067@s.whatsapp.net"
     xyx = `6289653381067@s.whatsapp.net`
       xyann = '6289653381067@s.whatsapp.net'
...
zeroyt7.on("group-participants-update", async (anu) => {
    ...
    try {
      ...
      if (anu.action == "add" && !mem.includes(zeroyt7.user.jid)) {
        ...
        sendButImage(mdata.id, wel, "JANGAN LUPA FOLLOW @iamghosky_", buff, but)
      }
      if (!isWelkom) return
      if (anu.action == "remove" && !mem.includes(zeroyt7.user.jid)) {
        ...
        sendButImage(mdata.id, out, "jgn balik lagi ya sayang", buff, but)
      }

...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
        ...
        let ajg = fs.readFileSync('./stik/dmcok.jpg')
...
//━━━━━━━━━━━━━━━[ BUTTON ]━━━━━━━━━━━━━━━━━//
        ...
        async function sendButLocation(id, text1, desc1, gam1, but = [], options = {}) {
            const buttonMessages = { locationMessage: { jpegThumbnail: ajg}, contentText: text1, footerText: desc1, buttons: but, headerType: 6 }
...
case 'allmenu':
  wbs = `${sender}`
  kontol = fs.readFileSync('./stik/dmcok.jpg')
img = fs.readFileSync('./zeroyt7/zero.jpg')
wibukauanjg = `───────❒ *[ ${botname} ]* ❒───────
...
[
          ...
          sendButLocation(from, wibukauanjg, kontol, wisnubanh, { thumbnail: Buffer.alloc(0), contextInfo: {mentionedJid: [wbs]}})
break
